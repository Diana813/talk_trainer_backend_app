...
from accent_analysis_service import AccentAnalysisService
...
path3 = os.path.join(base_dir, 'accent_audio_test_data\\test1c.wav')

accent_ok = [
    (path1, path2, 'komputer'),
]

accent_not_ok = [
    (path1, path3, 'komputer'),
]
